  ...
  return (
    <>
      ...
      <QueryClientProvider client={queryClient}>
        <div className='' style={{ background: `url(${bg}) cover/center no-repeat fixed` }}>
          ...
          <Suspense fallback={<div>Loading...</div>
            ...
            <Routes >
              ...
              <Route path='/loginbyemail' element={<LoginByEmail />} /> */}
                ...
                <Route path='/multiplayer/:roomId/:time' element={<Multiplayer />} />
              ...
              <Route path='/chessLearn' element={<ChessLearn />} />
              <Route path='/TournamentDetail' element={<TournamentDetail />} />
              <Route path='/LiveTournamentDetail/:id' element={<LiveTournamentDetail />} />
              <Route path='/playwithfriend/:time' element={<Playwithfriend />} />
              <Route path='/blog' element={<BlogList />} />
              <Route path='/puzzle' element={<Puzzle />} />
              <Route path='/blog' element={<BlogList />} />
              ...
              <Route path='/rate' element={<RateUs />} />
              <Route path='/analysisBoard/:roomId' element={<AnalysisBoard />} />
              <Route path='/productList/' element={<ProductList />} />
              <Route path='/Checkout/:id' element={<Checkout />} />
               <Route path='/deleteAccount' element={<AccountDeleteForm />} />
          ...
          <Suspense fallback={
            ...
            <Route path='/refundCancelationPolicy' element={<RefundCancelation />} />
